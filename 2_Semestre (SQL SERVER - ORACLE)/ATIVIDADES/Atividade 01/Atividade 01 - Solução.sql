-- Atividade 01 - Gest�o de S�cios e Dependentes

-- Execute os comandos SQL necess�rios para realizar as opera��es especificadas na atividade 01
...
-- 01.Criar a tabela CIDADE, conforme a especifica��o.
CREATE TABLE cidade (
    codigo NUMBER(4) PRIMARY KEY,
    nome VARCHAR2(30) NOT NULL
);

-- 02.Criar a tabela SOCIO, conforme a especifica��o.
CREATE TABLE socio (
...
-- 04. Alterar a tabela S�CIO para incluir nela os campos especificados.
...
-- 07. Alterar a tabela S�CIO para incluir o campo especificado.
ALTER TABLE socio add setor NUMBER(3) NOT NULL REFERENCES setor;

-- 08. Criar a tabela DEPENDENTE, conforme a especifica��o.
...
INSERT INTO setor VALUES (2, 'Cont�bil');
COMMIT;
